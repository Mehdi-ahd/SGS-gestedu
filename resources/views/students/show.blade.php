        ...
        <div class="card">
            <div class="card-body text-center">
                <div class="avatar avatar-lg mx-auto mb-3">
                    <img src="{{ ($student_documents->where("document_type", "Photo d'identité")->first()) ? Storage::url($student_documents->where("document_type", "Photo d'identité")->first()->document_path)  : asset('assets/img/default.webp') }}" alt="Photo de l'élève" class="img-fluid rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;">
                </div>
